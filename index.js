...
// ANSWER:
//O(n) is the best situation. It wouldn't be possible to change it to be O(1)
...
// ANSWER:
// For the first function we're just spliting a string and evaluting the characters to add them to the letters object. The second function there's a for loop iterating over the string but there isn't a second loop interating leading to say it is an O(n) like the first.
